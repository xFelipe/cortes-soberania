...
Operação single-tenant em VPS (ou máquina local). Cron dispara scripts que avançam o estado dos vídeos no SQLite. Cada vídeo passa por **triagem em camadas** de custo crescente: barato no início, caro só no fim.

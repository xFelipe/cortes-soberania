"""Transcriber via Groq Whisper API (escape hatch cloud gratuito)."""
...
class GroqWhisperTranscriber:
    """Chama Groq Whisper API com word timestamps.

    Requer GROQ_API_KEY. Limite de arquivo: 25 MB por request.
    """
    ...
    def transcribe(self, audio_path: Path) -> list[dict[str, Any]]:
        ...
        logger.info("Groq Whisper: transcrevendo {}...", audio_path.name)
        ...
        logger.info("Groq Whisper: {} segmentos", len(segments))
        return segments
